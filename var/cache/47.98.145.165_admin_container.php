...
class ReviveAdserverCachedContainer extends Container
{
    ...
    {
        return $this->services['filesystem'] = new \League\Flysystem\Filesystem(${($_ = isset($this->services['filesystem.adapter.local']) ? $this->services['filesystem.adapter.local'] : ($this->services['filesystem.adapter.local'] = new \League\Flysystem\Adapter\Local('/data/www/www/images', 0))) && false ?: '_'});
    }
    ...
    {
        return $this->services['filesystem.adapter.local'] = new \League\Flysystem\Adapter\Local('/data/www/www/images', 0);
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'webpath.admin' => '47.98.145.165/www/admin',
            'webpath.delivery' => '47.98.145.165/www/delivery',
            'webpath.deliverySSL' => '47.98.145.165/www/delivery',
            'webpath.images' => '47.98.145.165/www/images',
            'webpath.imagesSSL' => '47.98.145.165/www/images',
            ...
            'file.xmlrest' => 'ax.php',
            'store.mode' => '0',
            'store.webDir' => '/data/www/www/images',
            'store.ftpHost' => '',
            'store.ftpPath' => '',
            'store.ftpUsername' => '',
            'store.ftpPassword' => '',
            ...
            'email.qmailPatch' => '',
            'email.fromName' => '',
            'email.fromAddress' => 'liuning@instreet.cn',
            'email.fromCompany' => '',
